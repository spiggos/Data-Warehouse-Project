...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> Insterting Data Into Table: bronze.crm_cust_info';
		...
		PRINT '>> Insterting Data Into Table: bronze.crm_prd_info';
		...
		PRINT '>> Insterting Data Into Table: bronze.crm_sales_details';
		...
		PRINT '>> Insterting Data Into Table: bronze.erp_cust_az12';
		...
		PRINT '>> Insterting Data Into Table: bronze.erp_loc_a101';
		...
		PRINT '>> Insterting Data Into Table: bronze.erp_px_cat_g1v2';
		...
		PRINT '>> Load Bronze Layer Duration:' + CAST(DATEDIFF(second,@bronze_start_time,@bronze_end_time) AS NVARCHAR) + ' seconds';
		PRINT '----------------';
	END TRY
	BEGIN CATCH
		PRINT '===========================================';
